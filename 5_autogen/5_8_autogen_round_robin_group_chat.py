...
critic_agent = AssistantAgent(
    name="critic",
    model_client=model_client,
    system_message="Provide brief, constructive feedback. Respond with 'APPROVE' when satisfied.",
)
...
async def main():
    ...
    async for message in team.run_stream(task="Write a crisp note on vector embeddings."):
